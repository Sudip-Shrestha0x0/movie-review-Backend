...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    fullReview: Attribute.Blocks & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiReviewpostgreReviewpostgre extends Schema.CollectionType {
  collectionName: 'reviewpostgres';
  info: {
    singularName: 'reviewpostgre';
    pluralName: 'reviewpostgres';
    displayName: 'Reviewpostgre';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::reviewpostgre.reviewpostgre',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::reviewpostgre.reviewpostgre': ApiReviewpostgreReviewpostgre;
